...
class Tower:
    ...
    def floor3(self):
        ...
        if input('Du kan gå till höger eller till vänster. Vad väljer du? ').lower() != "Höger":
            self.coolText('Dörren knakar och långsamt uppenbarar sig rummet framför dina ögon', 0.02, True)
